...
// Helper function to format names: "gökhan eroğlu" -> "Gökhan EROĞLU"
...
// 1. Raw Data from the provided list
const rawResidents = [
    ...
    // Daire 8 ve 9 boş görünüyor listede, atlıyoruz.
    ...
    { name: "Utku ALKAN", plate1: "06BV865", plate2: "67EH350", phone1: "5317360680", phone2: "5377004222", block: "A1", apt: "12" }, // Plaka notu: 67TC650 de var ama 2 alan var.
    ...
    { name: "Kerem KAZAN", plate1: "34CVC749", plate2: "", phone1: "5305010403", phone2: "5056449278", block: "B1", apt: "7" },
    { name: "Serbay BAĞÇİÇEK", plate1: "67M0190", plate2: "34 meg 424", phone1: "5327789465", phone2: "5387331706", block: "B1", apt: "8" },
    ...
    { name: "Yılmaz YANIK", plate1: "34EZ0641", plate2: "", phone1: "5395977590", phone2: "", block: "B2", apt: "3" },
    ...
    { name: "Enes KARAOĞLU", plate1: "", plate2: "", phone1: "5352801940", phone2: "5432405581", block: "B2", apt: "12" }, // Daire 12 ve 13 yer değişmiş olabilir listede, sıraya göre gidiyorum.
    ...
    { name: "Emre ZİLAN", plate1: "67AAZ788", plate2: "67FB008", phone1: "5314387639", phone2: "", block: "B2", apt: "27" },
    ...
    { name: "Zekai ÇAĞLAR", plate1: "", plate2: "", phone1: "5411257467", phone2: "", block: "C1", apt: "16" }, // Bilimsel notasyon hatası vardı, sadece 1. noyu aldım.
    // Daire 17 boş
    ...
    { name: "İsmail ÖRSEL", plate1: "67AEZ583", plate2: "", phone1: "5543313111", phone2: "5363987870", block: "C2", apt: "12" },
    // Daire 13 boş
    ...
    { name: "Ünal ÖZDEMİR", plate1: "DUKM101", plate2: "DUKM121", phone1: "5397284376", phone2: "", block: "C2", apt: "32" }, // Telefon hatası düzeltildi
];

// 2. Process Users Array
// ID 1 reserved for Admin
...
// Generate User Objects from Raw Data
rawResidents.forEach((res, index) => {
    ...
    users.push({
        id: index + 100, // Start IDs from 100
        name: formatNameSurname(res.name), // Format the name here
        email: `${emailName}@site.com`,
        password: '123',
        role: 'Daire Sahibi', // Default role
        isActive: true,
...
export const mockAnnouncements: Announcement[] = [
    { id: 1, title: 'Yeni Yönetim Sistemi', content: 'Yeni site yönetim sistemimiz aktif edilmiştir. Tüm sakinlerimizin bilgileri güncellenmiştir.', date: new Date().toLocaleDateString('tr-TR') },
];

// Helper to generate apartments and assign residents
const generateApartments = (blockName: string, count: number): Apartment[] => {
    return Array.from({ length: count }, (_, i) => {
        const aptNumber = (i + 1).toString();
        
        // Find resident for this block and apt
        ...
        if (rawResIndex !== -1) {
            residentId = rawResIndex + 100; // Match the ID generation logic above
            status = 'Dolu';
        }

        return {
            id: parseInt(`${blockName.charCodeAt(0)}${blockName.charCodeAt(1) || 0}${100 + i}`), // Generate roughly unique ID
            number: aptNumber,
            status: status,
...
export const mockBlocks: Block[] = [
    {
        id: 1,
        name: 'A1 Blok',
        apartments: generateApartments('A1', 35)
    },
    {
        id: 2,
        name: 'A2 Blok',
        apartments: generateApartments('A2', 34)
    },
    {
        id: 3,
        name: 'B1 Blok',
        apartments: generateApartments('B1', 32)
    },
    {
        id: 4,
        name: 'B2 Blok',
        apartments: generateApartments('B2', 33)
    },
    {
        id: 5,
        name: 'C1 Blok',
        apartments: generateApartments('C1', 32)
    },
    {
        id: 6,
        name: 'C2 Blok',
        apartments: generateApartments('C2', 32)
    }
];
